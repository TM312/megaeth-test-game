...
class TransactionTracker:
    ...
    def record_transaction(self, key_code: int, direction: str, success: bool,
    ...
    def get_transaction_summary(self) -> Dict:
        ...
        return {
            ...
            'session_duration': str(self.end_time - self.start_time) if self.end_time and self.start_time else None
        }
